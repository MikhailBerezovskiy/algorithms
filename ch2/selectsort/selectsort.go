...
//	return A
//
//	loop invariant maintenance: in each iteration sub-loop iterate through remain part of array
//	  and search minimum value, and then swap minimum value with current value,
